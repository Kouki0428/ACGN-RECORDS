...
async function onConfirmUpdate() {
  ...
  const REPO_URL = 'https://github.com/Kouki0428/Bangumi-For-PC'
function openRepo() {
  ...
  <div>
    ...
    <section class="panel">
      ...
      <div class="arc-status" v-if="netStats?.today">
        ...
        <div class="arc-stat"><span>bgm / 其它</span><b>{{ fmtCount(netStats.today.bgmRequests) }} / {{ fmtCount(netStats.today.otherRequests) }}</b></div>
      </div>
    ...
    <section class="panel">
      ...
      <div class="row" style="align-items: center; margin: 0">
        ...
        <button class="btn btn--ghost btn--sm" @click="openRepo">Kouki0428/Bangumi-For-PC</button>
      </div>
